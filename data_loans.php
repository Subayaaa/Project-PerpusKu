                          ...
                          <td>
                            <div class="btn-group">
                              <button type="button" class="btn btn-info btn-xs">
                                <a class="text-light" href="tambah_loans.php?id=<?php echo $row['id'] ?>">
                                  Edit
                                </a>
                              </button>
                              <button type="button" class="btn btn-danger btn-xs">
                                <a class="text-light" href="delete_loans.php?id=<?php echo $row['id'] ?>">
                                  Hapus
                                </a>
                              </button>
                              <button type="button" class="btn btn-warning btn-xs">
                                <a class="text-light" href="tambah_kembali.php?id=<?php echo $row['id'] ?>">
                                  Kembalikan
                                </a>
                              </button>
                            </div>
